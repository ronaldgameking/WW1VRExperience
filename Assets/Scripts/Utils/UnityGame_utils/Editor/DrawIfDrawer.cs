...
namespace UnityUtils
{
    ...
    public class DrawIfDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                Debug.LogWarning($"You may specified a incorrect field, try using nameof(yourFieldHere), {drawIf.comparedPropertyName} is not a field or property of {targetObjectClassType} OR your field is private");
