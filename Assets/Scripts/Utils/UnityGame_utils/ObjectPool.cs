...
{
    /// <summary>
    /// A object pool to pool gameobjects, supports dynamic pool size with <see cref="AllowResize"/> and <see cref="MaxGrow"/>
    /// </summary>
    public class ObjectPool : MonoBehaviour
    {
        ...
        /// <summary>
        /// Gets an object from the pool and places it at the given position and rotates it to the given rotation
        /// </summary>
        /// <param name="pos">Position to place the object at</param>
        /// <param name="rot">Rotation to rotate the object to</param>
        /// <param name="par">Transform to parent the object under</param>
